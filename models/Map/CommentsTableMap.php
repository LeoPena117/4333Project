...
class CommentsTableMap extends TableMap
{
     ...
     */
    const COL_USER = 'comments.User';

    /**
     * the column name for the Senator field
     */
    const COL_SENATOR = 'comments.Senator';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Comment', 'User', 'Senator', ),
        self::TYPE_CAMELNAME     => array('id', 'comment', 'user', 'senator', ),
        self::TYPE_COLNAME       => array(CommentsTableMap::COL_ID, CommentsTableMap::COL_COMMENT, CommentsTableMap::COL_USER, CommentsTableMap::COL_SENATOR, ),
        self::TYPE_FIELDNAME     => array('ID', 'Comment', 'User', 'Senator', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Comment' => 1, 'User' => 2, 'Senator' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'comment' => 1, 'user' => 2, 'senator' => 3, ),
        self::TYPE_COLNAME       => array(CommentsTableMap::COL_ID => 0, CommentsTableMap::COL_COMMENT => 1, CommentsTableMap::COL_USER => 2, CommentsTableMap::COL_SENATOR => 3, ),
        self::TYPE_FIELDNAME     => array('ID' => 0, 'Comment' => 1, 'User' => 2, 'Senator' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('Senator', 'Senator', 'INTEGER', true, null, null);
    } // initialize()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CommentsTableMap::COL_USER);
            $criteria->addSelectColumn(CommentsTableMap::COL_SENATOR);
        } else {
            $criteria->addSelectColumn($alias . '.ID');
            $criteria->addSelectColumn($alias . '.Comment');
            $criteria->addSelectColumn($alias . '.User');
            $criteria->addSelectColumn($alias . '.Senator');
        }
    }
