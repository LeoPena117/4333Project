...
class UsersTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Username', 'PasswordHash', 'State', ),
        self::TYPE_CAMELNAME     => array('id', 'username', 'passwordHash', 'state', ),
        self::TYPE_COLNAME       => array(UsersTableMap::COL_ID, UsersTableMap::COL_USERNAME, UsersTableMap::COL_PASSWORD_HASH, UsersTableMap::COL_STATE, ),
        self::TYPE_FIELDNAME     => array('id', 'username', 'password_hash', 'state', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Username' => 1, 'PasswordHash' => 2, 'State' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'username' => 1, 'passwordHash' => 2, 'state' => 3, ),
        self::TYPE_COLNAME       => array(UsersTableMap::COL_ID => 0, UsersTableMap::COL_USERNAME => 1, UsersTableMap::COL_PASSWORD_HASH => 2, UsersTableMap::COL_STATE => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'username' => 1, 'password_hash' => 2, 'state' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
