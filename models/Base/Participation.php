 ...
 */
abstract class Participation implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\ParticipationTableMap';
    ...
    /**
     * Initializes internal state of Base\Participation object.
     */
    ...
    /**
     * Compares this with another <code>Participation</code> instance.  If
     * <code>obj</code> is an instance of <code>Participation</code>, delegates to
     * <code>equals(Participation)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Participation The current object, for fluid interface
     */
    ...
    /**
     * Get the [commitees] column value.
     *
     * @return int
     */
    public function getCommitees()
    {
        return $this->commitees;
    }
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[ParticipationTableMap::COL_ID] = true;
        }
     ...
     * @return $this|\Participation The current object (for fluent API support)
     */
    public function setCommitees($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
        ...
        if ($this->commitees !== $v) {
            $this->commitees = $v;
            $this->modifiedColumns[ParticipationTableMap::COL_COMMITEES] = true;
        }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildParticipationQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Participation::setDeleted()
     * @see Participation::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildParticipationQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ParticipationTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    {
        $pos = ParticipationTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['Participation'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Participation'][$this->hashCode()] = true;
    ...
    {
        $criteria = ChildParticipationQuery::create();
        $criteria->add(ParticipationTableMap::COL_ID, $this->id);
    ...
    {
        return (string) $this->exportTo(ParticipationTableMap::DEFAULT_STRING_FORMAT);
    }
