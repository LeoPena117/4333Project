...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 28, 2018 at 07:18 PM
...
--
-- Table structure for table `key stances`
--
...
CREATE TABLE `participation` (
  `ID` int(11) NOT NULL,
  `Votes Cast` int(11) NOT NULL,
  `Sessions Attended` int(11) NOT NULL,
...
(2, 'User', '$2y$10$epTca4OgtsAfAoT4g4wg3uvqsTannrvg59B4UUyuLW3VVINZH10aW', 'TX', ''),
(15, 'Leonel', '$2y$10$h7HRnMH5VTv9kh7fL0VJKOrm9cdwpOf34bnn9joMViuHJWn.R13ki', 'AL', 'True'),
(16, 'Leo', '$2y$10$yq80ywwD9GKUSQdIZip9y.i5sG1D5vZFGinh0s9lchjuKhObOlxW2', 'TX', ''),
(17, 'Something', '$2y$10$tTSIO3cyi50U5hHWIrp7V.dk/3paDXzLKi97mKVWW7YnLuZE8bb0S', 'AL', ''),
(18, 'Leon', '$2y$10$4Tb93couPSEKXfxnPsE18e91WkBsoMzamTkaIQ/9jLT6xtPi2QIO2', 'TX', ''),
(19, 'L', '$2y$10$NmxCO..HFBKHcgioEtK/EeJyQep05xgD/0g6uZT6tAca6/3Uwi5u.', 'KY', ''),
(20, 'LeonelPena', '$2y$10$xl4NdxG.bSVMlbsT6xOvGeK4dAox5NTy/zX5biM8y/yzL770Gx3OS', 'KY', '');
...
--
-- Indexes for table `key stances`
--
ALTER TABLE `key stances`
  ADD PRIMARY KEY (`ID`);
...
--
-- AUTO_INCREMENT for table `key stances`
--
ALTER TABLE `key stances`
